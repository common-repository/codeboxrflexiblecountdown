...
?>
<?php
$plugin_url = CBFCHelper::url_utmy('https://codeboxr.com/product/cbx-flexible-event-countdown-for-wordpress/');
$doc_url    = CBFCHelper::url_utmy('https://codeboxr.com/documentation-for-cbx-countdown-for-wordpress/');
?>
<div class="wrap">
    <div class="cbx-backend_container_header">
        <div class="cbx-backend_wrapper cbx-backend_header_wrapper">
            <div class="menu-heading">
                <img title="CBX Flexible Countdown - Helps & Updates"
                     src="<?php echo CBFC_PLUGIN_ROOT_URL.'assets/images/icon_log.svg'
                     ?>" alt="CBX Flexible Countdown - Helps & Updates" width="32" height="32">
                <h2 class="wp-heading-inline wp-heading-inline-setting">
                    <?php esc_html_e('CBX Flexible Countdown - Helps & Updates', 'codeboxrflexiblecountdown'); ?>
                </h2>
            </div>
            <a href="<?php echo admin_url().'options-general.php?page=codeboxrflexiblecountdown' ?>" class="button button-primary
            save-settings"> <?php esc_html_e('Go to Settings', 'codeboxrflexiblecountdown'); ?><img
            ...
            <div class="cbx-backend-row">
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                    ...
                    <div class="cbx-backend-card">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Get Free & Pro Addons', 'codeboxrflexiblecountdown'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-row">
                                <div class="cbx-backend-col col-xs-12 col-md-12 text-xs-left">
                                    <div class="cbx-backend-feature-card">
                                        <div class="feature-card-body static">
                                            <div class="feature-card-header">
                                                <a href="<?php echo esc_url($plugin_url); ?>"
                                                   target="_blank"> <img
                                                            src="https://codeboxr.com/wp-content/uploads/productshots/40-profile.png"
                                                            alt="CBX Flexible Countdown for WordPress"/> </a>

                                            </div>
                                            <div class="feature-card-description">
                                                <h3>
                                                    <a href="<?php echo esc_url($plugin_url); ?>"
                                                       target="_blank">CBX Flexible Countdown Pro Addon</a></h3>
                                                <p>Pro features for CBX Flexible Countdown plugin.</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="cbx-backend-card dashboard-plugin-Integration">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Third Party plugin Integration',
                                        'codeboxrflexiblecountdown'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <p>
                                    ...
                                    <?php esc_html_e('The Events Calendar', 'codeboxrflexiblecountdown'); ?></p>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                    ...
                                    <?php esc_html_e('Events Manager', 'codeboxrflexiblecountdown'); ?></p>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                    ...
                                    <?php esc_html_e('My Calendar', 'codeboxrflexiblecountdown'); ?></p>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                    ...
                                    <?php esc_html_e('Event Organiser', 'codeboxrflexiblecountdown'); ?></p>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                    ...
                                    <?php esc_html_e('Events Made Easy', 'codeboxrflexiblecountdown'); ?></p>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                    ...
                                    <?php esc_html_e('Sportspress', 'codeboxrflexiblecountdown'); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Other WordPress Plugins', 'codeboxrflexiblecountdown'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <?php
                ...
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                    ...
                    <div class="cbx-backend-card dashboard-support">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Help & Supports', 'codeboxrflexiblecountdown'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <a href="https://codeboxr.com/contact-us" target="_blank">
                                    ...
                                    <?php esc_html_e('Access our Premium Support', 'codeboxrflexiblecountdown'); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20Next%20Previous%20Link"
                                   target="_blank">
                                    ...
                                    <?php esc_html_e('Quick Support (Email)', 'codeboxrflexiblecountdown'); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url($plugin_url); ?>" target="_blank">
                                    ...
                                    <?php esc_html_e('CBX Flexible Countdown Plugin Information',
                            ...
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url($doc_url); ?>" target="_blank">
                                    ...
                                    <?php esc_html_e('Read the CBX Flexible Countdown User Guide',
                                        'codeboxrflexiblecountdown'); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/codeboxrflexiblecountdown/reviews/#new-post"
                                   target="_blank">
                                    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <?php esc_html_e('Rate Our Plugin', 'codeboxrflexiblecountdown'); ?> </a>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Changelog', 'codeboxrflexiblecountdown'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[Bug fix]</strong> Demo link fixed</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[New]</strong> Add new help & doc page.</li>
                                    <li><strong>[Improvement]</strong> Backend UI improved.</li>
                                    <li><strong>[Improvement]</strong> Some minor improvements.</li>
                                    <li><strong>[Improvement]</strong> WordPress 5.7 compatibility update.</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[Bug fix]</strong> WPBakery Page builder compatibility fix.</li>
                                    <li><strong>[Improvement]</strong> WordPress 5.6 compatibility update.</li>
                                    <li><strong>[Improvement]</strong> UI improvement (Circular Countdown).</li>
                                    <li><strong>[Improvement]</strong> Some minor improvements.</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[Bug Fix]</strong> Circular and Light countdown css now flow flex based
                                        display and centered easily
                                    </li>
                                    <li><strong>[Improvement]</strong> Some minor improvements</li>
                                </ul>
                            </div>
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Codeboxr News Updates', 'codeboxrflexiblecountdown'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <?php
