...
<div id="postbox-container-1" class="postbox-container">
    <div class="meta-box-sortables">
        <div class="postbox">
            <h3><?php esc_html_e('Help & Supports', 'codeboxrflexiblecountdown') ?></h3>
            <div class="inside">
                <?php
                ...
                <p><span class="dashicons dashicons-info"></span> <a href="<?php echo esc_url($plugin_url); ?>"
                                                                     target="_blank">Plugin Information</a></p>
                ...
                <p><span class="dashicons dashicons-star-half"></span> <a
                            href="https://wordpress.org/support/plugin/codeboxrflexiblecountdown/reviews/#new-post"
                            target="_blank">Review This Plugin</a></p>
                <p><span class="dashicons dashicons-external"></span> <a href="https://codeboxr.com/contact-us"
                                                                         target="_blank"> Contact Us for Support</a></p>
            </div>
        </div>
        <div class="postbox">
            <h3><?php esc_html_e('Other WordPress Plugins', 'codeboxrflexiblecountdown'); ?></h3>
            <div class="inside">
                <?php
        ...
        <div class="postbox">
            <h3><?php esc_html_e('Codeboxr News Updates', 'codeboxrflexiblecountdown') ?></h3>
            <div class="inside">
                <?php
                include_once(ABSPATH.WPINC.'/feed.php');
                if (function_exists('fetch_feed')) {
